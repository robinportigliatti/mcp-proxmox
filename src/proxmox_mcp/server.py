...
def main() -> None:
    ...
    if args.transport == "stdio":
        ...
        # SSE or HTTP mode for remote access (n8n, web apps, etc.)
        # Note: This is NOT for Cursor - Cursor requires STDIO mode
        ...
        print("NOTE: This mode is for remote access (n8n, web apps, API consumers).", file=sys.stderr)
        print("For Cursor, use STDIO mode (no --transport flag).", file=sys.stderr)
        print("", file=sys.stderr)
